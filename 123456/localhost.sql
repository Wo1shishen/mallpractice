...
-- 数据库: `jiujiulg`
--
CREATE DATABASE `jiujiulg` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jiujiulg`;
...
INSERT INTO `goodslist` (`sid`, `title`, `price`, `url`) VALUES
...
CREATE TABLE IF NOT EXISTS `goodslist_copy` (
  `sid` tinyint(2) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) CHARACTER SET utf8 NOT NULL,
  `price` varchar(20) CHARACTER SET utf8 NOT NULL,
  `url` varchar(200) NOT NULL,
...
--
-- 转存表中的数据 `goodslist_copy`
--

INSERT INTO `goodslist_copy` (`sid`, `title`, `price`, `url`) VALUES
(1, '南极人打底裤新款秋季外穿小脚裤糖果色女装大码修身百搭纯色裤子潮hh-N2Q5F50132A 黑色 S', '￥79', 'mart.com/pic/9906133a2ba320d5092a/BT62nn72_zClhdZMt2/59eyoatRpxlavR/CsmRr1g_uKiAFcsjAAJjtKLNIOw681_400x400.png'),
(2, '瑷諾·主题学院风连帽女卫衣秋冬新款宽松女装蝙蝠袖外套学生长袖上衣FZA-T9050 杏色 S', '￥89.9', 'http://img16.fn-mart.com/pic/fc91133e842b2a72ee7b/hTqnzz7TvnfdkMUdjn/1ioyoRvytaOaB9/CsmRslmpKn-ASFxLAALp8CwCsII547_400x400.jpg'),
(3, '鸭鸭2017新款女装韩版修身羽绒服女立领冬季短款时尚羽绒服B-361 橙色 155', '￥99', 'http://img18.fn-mart.com/pic/18f9133e4aa224febd84/B26zzz5TDnLgklUd3T/s9maoahyJiP9fi/CsmRslmKtpOAdBIIAARDg1cgvXk441_400x400.jpg'),
(4, 'Alice&you韩版大毛领连帽大码加厚棉衣女士2017新款女装中长款羽绒棉服2032 军绿色 3XL', '￥169', 'http://img17.fn-mart.com/pic/fc13133c904d28c88a07/BnHT2212FTtMkMudOn/19maoa_GWxJaWG/CsmRslnfItSAPNoWAAY1lUeQeMQ892_400x400.jpg'),
(5, '韩域丹依娜2017秋装韩版新款秋冬大码女装时尚修身显瘦气质长款麂皮绒风衣外套大衣潮 粉色(WB1727) S码', '￥279', 'http://img18.fn-mart.com/pic/d349133c948e31de3132/hzq2221nv2tdhlugX2/7xeamR_GTR2y_a/CsmRsVnaHVOAQz1oAAUhDry4oTI978_400x400.jpg'),
...
INSERT INTO `user` (`id`, `qq`, `username`, `password`, `email`, `date`) VALUES
(1, '11111111', 'aaa', '96e79218965eb72c92a549dd5a330112', 'email', '2017-10-17 17:04:52'),
(2, '111111111', '19912692255', '96e79218965eb72c92a549dd5a330112', '1111111122@qq.com', '2017-10-17 20:11:15'),
(3, '11111111111', '19912692251', '96e79218965eb72c92a549dd5a330112', '11111111111@qq.com', '2017-10-17 20:13:42'),
(4, '111111111113', '199126922512', '7fa8282ad93047a4d6fe6111c93b308a', '1111111111a1@qq.com', '2017-10-17 20:16:07'),
(33, '33333333333', '3333333333', '4aee3e28df37ea1af64bd636eca59dcb', '3333333333@qq.com', '2017-10-17 20:19:15'),
(34, '333343333333', '33333333333', 'd86641a4189b19defacd72ed661d6a88', '33333333333@qq.com', '2017-10-17 20:21:34');
